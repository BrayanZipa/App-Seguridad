                ...
                <div class="card card-dark card-tabs mt-n1 mb-n2">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            <li class="nav-item">
                                <a id="colaboradorConActivo" class="nav-link {{ old('casoIngreso2') == '' ? 'active' : '' }}" data-toggle="pill" href="#nuevo_colaboradorConActivo" role="tab" aria-controls="nuevo_colaboradorConActivo" aria-selected="true">
                                    Nuevo colaborador con activo</a>
                            </li>
                            <li class="nav-item">
                                <a id="colaboradorSinActivo" class="nav-link {{ old('casoIngreso2') != '' ? 'active' : '' }}" data-toggle="pill" href="#nuevo_colaboradorSinActivo" role="tab" aria-controls="nuevo_colaboradorSinActivo" aria-selected="false">
                                    Nuevo colaborador sin activo</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
