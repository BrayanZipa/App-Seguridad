...
@section('scripts')
    ...
    <!-- Scripts para el módulo de colaboradores, caso colaborador con activo y colaborador con vehículo y activo -->
    <script>
        $(function() {
    ...
    {{-- <!-- Scripts para el módulo de colaboradores, caso colaborador con vehículo -->
    <script>
        $(function() {
                            ...
                            <div class="card card-dark card-tabs mt-n1 mb-n2">
                                <div class="card-header p-0 pt-1">
                                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="colaboradorActivo" data-toggle="pill" href="#nuevo_colaborador"
                                                role="tab" aria-controls="nuevo_colaborador" aria-selected="true">Nuevo colabordor con activo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="colaboradorVehiculo" data-toggle="pill"
