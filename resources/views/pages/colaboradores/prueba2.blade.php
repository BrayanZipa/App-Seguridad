        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <select name="selectCodigo" id="selectCodigo" class="colaborador form-control {{ $errors->has('codigo') && old('casoIngreso2') == '' ? 'is-invalid' : '' }}" style="width: 100%;" required>
                        <option selected="selected" value="" disabled></option>
                        @foreach ($computadores as $computador)
                            <option value="{{ $computador['users_id'] }}"
                                {{ $computador['users_id'] == old('selectCodigo') && old('casoIngreso2') == '' ? 'selected' : '' }}>{{ $computador['name'] }}
                            </option>
                        @endforeach
                    </select>
