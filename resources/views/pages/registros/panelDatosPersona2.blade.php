<div class="card card-primary mb-4 mx-n1">
    <div class="card-header pb-1">
        ...
        <div class="card-tools">
            <button id="botonCollapse" type="button" class="btn btn-tool pb-3 mr-n1" data-card-widget="collapse">
                <i class="fas fa-minus"></i>
            </button>
            <button id="botonCerrar" type="button" class="btn btn-tool pb-3 mr-n3">
                ...
                <div id="cardPersona" class="card card-primary card-tabs mx-1">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="tabInfoVehiculo" data-toggle="pill" href="#infoVehiculo" role="tab" aria-controls="infoVehiculo" aria-selected="false">Vehículo</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            <div class="tab-pane fade active show" id="datosIngreso" role="tabpanel" aria-labelledby="tabDatosIngreso">
                                <div class="ml-4">
                                    ...
                                    <div class="row"> 
                                        <div id="infoVisitanteConductor" class="col-sm-8">
                                            <div class="row"> 
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <div class="description-block text-left">
                                        ...
                                        <div id="columnaDescripcion" class="col-sm-4">
                                            <div class="form-group">
                                                <div class="description-block text-left">
                            ...
                            <div class="tab-pane fade" id="infoVehiculo" role="tabpanel" aria-labelledby="tabInfoVehiculo">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="ml-4">Información del vehículo</label>
                                        <div class="ml-4">
                                            <div class="row">                              
                                                <div class="col-sm-3">
                                                    <div class="form-group">
