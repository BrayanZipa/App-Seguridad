<div class="card card-primary card-tabs mb-4 mx-n1">
    <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="tabInfoRegistro" data-toggle="pill" href="#infoRegistro" role="tab"
                    aria-controls="infoRegistro" aria-selected="true"></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="tabDatosVehiculo" data-toggle="pill" href="#infoVehiculo" role="tab"
                    aria-controls="infoVehiculo" aria-selected="false">Registro vehículo</a>
            </li>
    ...
    <div class="card-body mb-n4">
        <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="row">
                    <div id="columnaFoto" class="col-sm-3">
                        <div id="divFotoPersona" class="form-group">
                            ...
                            <img id="fotoPersona" class="img-fluid rounded" style="border: 1px solid #007bff" src=""
                                alt="Foto persona">
                        </div>
                    ...
                    <div id="columnaInformacion" class="col-sm-9">
                        ...
                        <div id="cardPersona" class="card card-primary card-tabs mx-1">
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tabDatosIngreso" data-toggle="pill"
                                            href="#datosIngreso" role="tab" aria-controls="datosIngreso"
                                            aria-selected="true">Datos de ingreso</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tabDatosBasicos" data-toggle="pill" href="#datosBasicos"
                                            role="tab" aria-controls="datosBasicos" aria-selected="false">Datos
                                            básicos</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tabDatosActivo" data-toggle="pill" href="#datosActivo"
                                            role="tab" aria-controls="datosActivo" aria-selected="false">Activo</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade active show" id="datosIngreso" role="tabpanel"
                                                ...
                                                <div id="infoVisitanteConductor" class="col-sm-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="description-block text-left">
                                                                    <h5 class="description-header mb-1">Empresa que visita
                                                                    </h5>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="description-block text-left">
                                                                    <h5 class="description-header mb-1">Colaborador a cargo
                                                                    </h5>
                                    ...
                                    <div class="tab-pane fade" id="datosBasicos" role="tabpanel"
                                        aria-labelledby="tabDatosBasicos">
                                        <div class="ml-4">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                            ...
                                            <div id="infoColaborador" class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <div class="description-block text-left">
                                                            <h5 class="description-header mb-1">Empresa a la que pertenece
                                                            </h5>
                                    ...
                                    <div class="tab-pane fade" id="datosActivo" role="tabpanel"
            ...
            <div class="tab-pane fade" id="infoVehiculo" role="tabpanel" aria-labelledby="tabDatosVehiculo">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label>Fotografía vehículo</label>
                            <img id="fotoVehiculo" class="img-fluid rounded" style="border: 1px solid #fd7e14"
                                src="" alt="Foto vehículo">
                        </div>
                    </div>
                    <div class="col-sm-9">
                        <label>Información del vehículo</label>
                        <div class="card card-orange card-tabs ml-1 mr-n1">
                            <div class="card-header p-0 pt-1">
                                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tabDatosIngresoVehiculo" data-toggle="pill"
                                            href="#datosIngresoVehiculo" role="tab"
                                            aria-controls="datosIngresoVehiculo" aria-selected="true">Datos de ingreso</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-one-tabContent">
                                    <div class="tab-pane fade active show" id="datosIngresoVehiculo" role="tabpanel"
