                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="inputNumeroIdentificador">Número identificador del vehículo</label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="selectTipoVehiculo">Tipo de vehículo</label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="selectMarcaVehiculo">Marca del vehículo</label>
